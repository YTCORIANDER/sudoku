...
public class TestSudoku {
	...
	public static void main(String[] args) {
		...
		if (b2) {
			...
			// System.out.println(s2.getGrid());
			// System.out.println(g2);
			// System.out.println(b2);
		} else {
			System.out.println("Test 1 Failed");
			//System.out.println(s2.getDigitAt(1, 4));
	...
	// 	// ---------- Test 5 ---------- [isValidCol]
		...
		//System.out.println(s5.isValidCol(7));
		//System.out.println(s5.isValidCol(8));
		if (b3) {
	...
	// 	// ---------- Test 6 ---------- [isValidBox (only for 9-based sudokus)]
		...
		if (b3) {
			...
			System.out.println(b3);
			System.out.println(s5.isValidBox(6, 6));
		}
	...
	// 	// ---------- Test 7 ---------- [isValidSolution]
		...
		if (b3) {
			...
			System.out.println(s4.isValidSolution());
		}
	...
	// 	// ---------- Test 8 ---------- [isValidSolution]
		...
		if (b3) {
			...
			System.out.println(b3);
			System.out.println(s8.isValidSolution());
		}
